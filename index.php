...
$_REQUEST['USERNAME']= par_rep('/[^A-Za-z0-9\-]_/', '', $_REQUEST['USERNAME']); 
if(isset($_POST['USERNAME']))
$_POST['USERNAME']= par_rep('/[^A-Za-z0-9\-]_/', '', $_POST['USERNAME']); 
if(isset($_GET['USERNAME']))
$_GET['USERNAME']= par_rep('/[^A-Za-z0-9\-]_/', '', $_GET['USERNAME']); 
...
elseif($_REQUEST['modfunc']!='create_account')
{
    echo "
        ...
        <HTML>
            <HEAD><TITLE>".Config('TITLE')."</TITLE><link rel=\"shortcut icon\" href=\"favicon.ico\"><meta http-equiv='Content-Type' content='text/html; charset=utf-8'>
			 </HEAD>";
